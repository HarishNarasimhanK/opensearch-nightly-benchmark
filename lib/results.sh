...
CSV_HEADERS="date,run_id,engine,workload,min_throughput,mean_throughput,median_throughput,max_throughput,error_rate,p50_latency_ms,p99_latency_ms,duration_sec,ingest_percentage,status,error_reason,mode,parquet_repo,parquet_branch"
...
parse_osb_results() {
  ...
  local csv_file="/tmp/nightly-result-${engine}-${workload}.csv"
...
parse_and_store_results() {
  ...
  echo "${date_str},${run_id},parquet,${workload},${pq_metrics},${duration_sec},${CONFIG_INGEST_PERCENTAGE},success,,${mode},${CONFIG_PARQUET_REPO},${CONFIG_PARQUET_BRANCH}" >> "$local_csv"
  echo "${date_str},${run_id},parquetLucene,${workload},${pql_metrics},${duration_sec},${CONFIG_INGEST_PERCENTAGE},success,,${mode},${CONFIG_PARQUET_REPO},${CONFIG_PARQUET_BRANCH}" >> "$local_csv"
  echo "${date_str},${run_id},lucene,${workload},${lu_metrics},${duration_sec},${CONFIG_INGEST_PERCENTAGE},success,,${mode},${CONFIG_LUCENE_REPO},${CONFIG_LUCENE_BRANCH}" >> "$local_csv"
...
record_failure() {
  ...
  echo "${date_str},${run_id},parquet,${workload},0,0,0,0,0,0,0,0,${CONFIG_INGEST_PERCENTAGE},failed,${error_reason},${mode},${CONFIG_PARQUET_REPO},${CONFIG_PARQUET_BRANCH}" >> "$local_csv"
  echo "${date_str},${run_id},parquetLucene,${workload},0,0,0,0,0,0,0,0,${CONFIG_INGEST_PERCENTAGE},failed,${error_reason},${mode},${CONFIG_PARQUET_REPO},${CONFIG_PARQUET_BRANCH}" >> "$local_csv"
  echo "${date_str},${run_id},lucene,${workload},0,0,0,0,0,0,0,0,${CONFIG_INGEST_PERCENTAGE},failed,${error_reason},${mode},${CONFIG_LUCENE_REPO},${CONFIG_LUCENE_BRANCH}" >> "$local_csv"
